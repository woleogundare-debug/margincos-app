...
- **Inelastic (between 0 and -1):** Volume drops less than the price rises. Revenue goes up. Price increases here are nearly always margin-accretive.
...
- **Elastic (more negative than -1):** Volume drops more than the price rises. Revenue falls. Price increases are usually margin-destructive unless variable costs were already deep into the margin structure.
