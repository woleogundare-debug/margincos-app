export const VERTICALS = ['FMCG', 'Manufacturing', 'Retail', 'Logistics'];
...
export const TIER_ACCESS = {
  ...
  professional: {
    ...
    modules: false,
    label: 'Enterprise',
    allowedPillars: ['P1', 'P2', 'P3', 'P4'],
  },
  enterprise: {
    pillars: ['pricing', 'cost', 'channel', 'trade'],
    modules: true,
    label: null,
    allowedPillars: ['P1', 'P2', 'P3', 'P4', 'M1', 'M2', 'M3', 'M4'],
  },
};

// Seat, SKU, lane, division, and period caps per tier — null means unlimited.
// Mirrored at the DB layer by enforce_tier_limit() trigger function (see
// supabase/migrations/20260428124257_enforce_tier_limits_via_db_trigger.sql).
// If a value here changes, re-apply the migration with matching values.
export const TIER_LIMITS = {
  essentials:   { maxMembers: 1,    maxSkus: 50,   maxLanes: 50,   maxDivisions: 1,    maxPeriods: 1    },
  professional: { maxMembers: 5,    maxSkus: 200,  maxLanes: 200,  maxDivisions: 3,    maxPeriods: null },
  enterprise:   { maxMembers: null, maxSkus: null, maxLanes: null, maxDivisions: null, maxPeriods: null },
};
...
export const COMING_SOON_VERTICALS = ['IT Services', 'Telecoms', 'Aviation', 'Healthcare', 'Financial Services'];
