...
// ── NULL-preserving extractor ─────────────────────────────────────────────
// Returns null for genuinely missing input (null / undefined / '') so a blank
// pct field is not read as an observed 0%. See lib/engine/CONVENTIONS.md.
export const nOrNull = (v) => {
